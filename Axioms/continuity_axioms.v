...
Definition two_points_line_circle := forall A B U V P,
  Col U V P -> U <> V -> Bet A P B ->
  exists Z1 Z2, Col U V Z1 /\ 在圆上 Z1 A B /\
                Col U V Z2 /\ 在圆上 Z2 A B /\
...
Definition circle_circle_two := forall A B C D P Q,
  ...
  在圆上或圆外 Q A B ->
  exists Z1 Z2,
    在圆上 Z1 A B /\ 在圆上 Z1 C D /\
    在圆上 Z2 A B /\ 在圆上 Z2 C D /\
    (在圆内 P A B -> 在圆外 Q A B -> Z1<>Z2).
