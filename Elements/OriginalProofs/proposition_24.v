...
Lemma proposition_24 : 
   forall A B C D E F, 
   Triangle A B C -> Triangle D E F -> Cong A B D E -> Cong A C D F -> 角度小于 E D F B A C ->
   Lt E F B C.
Proof.
intros.
...
assert (等角 E D F B A H) by (conclude lemma_equalangleshelper).
assert (等角 B A H E D F) by (conclude lemma_equalanglessymmetric).
assert (等角 H A B F D E) by (conclude lemma_equalanglesflip).
assert ((Cong H B F E /\ 等角 A H B D F E /\ 等角 A B H D E F)) by (conclude proposition_04).
...
by cases on (BetS A H J \/ eq J H \/ BetS A J H).
{
 ...
 assert (角度小于 J C H C H A) by (conclude proposition_16).
 assert (~ Col H C J).
  {
  intro.
 ...
 assert (等角 H C J J C H) by (conclude lemma_ABCequalsCBA).
 assert (角度小于 H C J C H A) by (conclude lemma_angleorderrespectscongruence2).
 assert (~ Col A H C).
  {
  intro.
  assert (Col A C H) by (forward_using lemma_collinearorder).
 ...
 assert (等角 A H C C H A) by (conclude lemma_ABCequalsCBA).
 assert (角度小于 H C J A H C) by (conclude lemma_angleorderrespectscongruence).
 ...
 assert (等角 C H J C H J) by (conclude lemma_equalanglesreflexive).
 assert (neq C J) by (forward_using lemma_angledistinct).
 assert (neq C H) by (forward_using lemma_angledistinct).
 assert (角度小于 C H J C H B) by (conclude_def 角度小于 ).
 assert (~ Col C A H).
  {
  intro.
  assert (Col A C H) by (forward_using lemma_collinearorder).
 ...
 assert (角度小于 A C H C H J) by (conclude proposition_16).
 assert (角度小于 H C J A C H) by (conclude lemma_angleorderrespectscongruence).
 assert (角度小于 H C J C H J) by (conclude lemma_angleordertransitive).
 assert (角度小于 H C J C H B) by (conclude lemma_angleordertransitive).
 ...
 assert (等角 H C J H C J) by (conclude lemma_equalanglesreflexive).
 assert (等角 H C J H C B) by (conclude lemma_equalangleshelper).
 assert (等角 H C B H C J) by (conclude lemma_equalanglessymmetric).
 assert (角度小于 H C B C H B) by (conclude lemma_angleorderrespectscongruence2).
 assert (~ Col B H C).
  {
  intro.
  assert (Col C J B) by (conclude_def Col ).
 ...
 assert (等角 B H C C H B) by (conclude lemma_ABCequalsCBA).
 assert (角度小于 H C B B H C) by (conclude lemma_angleorderrespectscongruence).
 ...
 }
{
 ...
 assert (等角 H C B H C B) by (conclude lemma_equalanglesreflexive).
 assert (Out C B J) by (conclude lemma_ray4).
 assert (Out C H H) by (conclude lemma_ray4).
 assert (等角 H C B H C J) by (conclude lemma_equalangleshelper).
 assert (BetS H J A) by (conclude axiom_betweennesssymmetry).
 assert (角度小于 H C B H C A) by (conclude_def 角度小于 ).
 assert (~ Col B C H).
  {
  intro.
  assert (Col H C B) by (forward_using lemma_collinearorder).
 ...
 assert (角度小于 B C H H C A) by (conclude lemma_angleorderrespectscongruence2).
 assert (等角 A C H H C A) by (conclude lemma_ABCequalsCBA).
 assert (角度小于 B C H A C H) by (conclude lemma_angleorderrespectscongruence).
 assert (等角 A H C A C H) by (conclude lemma_equalanglessymmetric).
 assert (角度小于 B C H A H C) by (conclude lemma_angleorderrespectscongruence).
 assert (~ Col A H C).
  {
  intro.
  assert (Col A C H) by (forward_using lemma_collinearorder).
 ...
 assert (等角 A H C C H J) by (conclude lemma_equalangleshelper).
 assert (角度小于 A H C C H B) by (conclude_def 角度小于 ).
 assert (~ Col B H C).
  {
  intro.
  assert (Col H C B) by (forward_using lemma_collinearorder).
 ...
 assert (等角 B H C C H B) by (conclude lemma_ABCequalsCBA).
 assert (角度小于 A H C B H C) by (conclude lemma_angleorderrespectscongruence).
 assert (角度小于 B C H B H C) by (conclude lemma_angleordertransitive).
 assert (~ Col H C B).
  {
  intro.
 ...
 assert (等角 H C B B C H) by (conclude lemma_ABCequalsCBA).
 assert (角度小于 H C B B H C) by (conclude lemma_angleorderrespectscongruence2).
 assert (Triangle B H C) by (conclude_def Triangle ).
 assert (Lt B H B C) by (conclude proposition_19).
 assert (Cong B H H B) by (conclude cn_equalityreverse).
 assert (Lt H B B C) by (conclude lemma_lessthancongruence2).
