...
let Tf:=fresh in
assert (Tf:exists R, (BetS E H R /\ Cong H R E H)) by (conclude lemma_extension);destruct Tf as [R];分离合取式.
...
let Tf:=fresh in
assert (Tf:exists P Q M, (BetS P D Q /\ 等角 P D H D H E /\ Par P Q R E /\ BetS P M E /\ BetS D M H)) by (conclude proposition_31short);destruct Tf as [P[Q[M]]];分离合取式.
